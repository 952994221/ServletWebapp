...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-5" data-genuitec-path="/findu/WebRoot/html/categories.jsp">
	<%@include file="head.jsp"%>
	<%@include file="menu_search.jsp" %>
	
	<!-- breadcrumbs -->
	<div class="w3layouts-breadcrumbs text-center" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-5" data-genuitec-path="/findu/WebRoot/html/categories.jsp">
		<div class="container">
			...
			<div class="category-list">
				<div id="parentVerticalTab">
					...
					<div class="resp-tabs-container hor_1">
						<span class="active total" style="display:block;" data-toggle="modal" data-target="#myModal"><strong>成都市</strong> (选择你的区域查看你附近的物品)</span>
						<div>
							<div class="category">
