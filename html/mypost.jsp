...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-46" data-genuitec-path="/findu/WebRoot/html/mypost.jsp">
    <div class="panel admin-panel" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-46" data-genuitec-path="/findu/WebRoot/html/mypost.jsp">
        ...
        <table class="table table-hover text-center">
            ...
            <tr>
                ...
                <td>
                	...
                	%>
                	<%if(Integer.parseInt(applyCount)>=0){ %>
