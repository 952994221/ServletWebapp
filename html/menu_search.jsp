...
<div class="container">
	<div class="agile-its-header">
		<div class="logo">
			<h1>
				<a href="/FindU/html/index.jsp"><span>首页</span></a>
			</h1>
		</div>
		<div class="agileits_search" style="position:relative">
			<form autocomplete="off" action="/FindU/servlet/SearchServlet"
				...
				<input id="Search" name="Search" value="<%=searchx %>"
					type="text" required=""> <select
					id="agileinfo_search" name="agileinfo_search" required="">
					<option value="AllTypes">物品类型</option>
					<%
				...
				<button type="submit" class="btn btn-default" style="background-color: #0099e5"
					aria-label="Left Align">
					<i class="fa fa-search" aria-hidden="true"> </i>
				</button>
			</form>
			<a class="post-w3layouts-ad" href="/FindU/html/post-ad.jsp">发布</a>
			<div id="context"
