...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-43" data-genuitec-path="/findu/WebRoot/html/message.jsp">
    ...
    //breadcrumbs -->
    <!-- Submit Ad -->
    <div class="submit-ad main-grid-border" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-43" data-genuitec-path="/findu/WebRoot/html/message.jsp">
        <div class="container">
            <h2 class="w3-head"></h2>
