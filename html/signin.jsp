...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-55" data-genuitec-path="/findu/WebRoot/html/signin.jsp">

	<%@include file="head.jsp"%>
	<%@include file="menu_search.jsp"%>

	<!-- sign in form -->
	<section data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-55" data-genuitec-path="/findu/WebRoot/html/signin.jsp">
			...
			<div class="agileinfo_signin">
				...
				<form action="/FindU/html/LoginServlet" method="post">
					<input type="text" name="Name" placeholder="手机号或邮箱" required=""
						...
						<a href="/FindU/html/signup.jsp"><input type="button" value="注册"> </a>
