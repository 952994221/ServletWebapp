...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/findu/WebRoot/html/applymanage.jsp">
    <form method="post" action="" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/findu/WebRoot/html/applymanage.jsp">
            ...
            <table class="table table-hover text-center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        %>
                            <a class="button border-main" href="javascript:void(0)" onclick="return pass(<%=a.getId() %>)"><span class="icon-edit"></span> 通过</a>
