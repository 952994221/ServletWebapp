...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-56" data-genuitec-path="/findu/WebRoot/html/signup.jsp">
	<%@include file="head.jsp"%>
	<%@include file="menu_search.jsp"%>

	<!-- sign up form -->
	<section data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-56" data-genuitec-path="/findu/WebRoot/html/signup.jsp">
