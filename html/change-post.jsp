...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-7" data-genuitec-path="/findu/WebRoot/html/change-post.jsp">
    ...
    //breadcrumbs -->
    <!-- Submit Ad -->
    <div class="submit-ad main-grid-border" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-7" data-genuitec-path="/findu/WebRoot/html/change-post.jsp">
        <div class="container">
            ...
            <div class="post-ad-form">
                <form id="information" action="/FindU/servlet/ChangePostServlet" method="post" enctype="multipart/form-data">
                    ...
                    <div class="personal-details">
                            ...
                            <div class="clearfix"></div>
                            <label>物品状态 <span>*</span></label>
                    		<select class="" name="Option2">	
                        		<option value=0>等待认领中</option>
                        		<option value=1>已物归原主</option>
                    		</select>
                    		<div class="clearfix"></div>	
	                        ...
	                        <div class="photos-upload-view">
	                            ...
	                            <div id="messages">
	                                <p>图片预览 <font color='#ff0000'></font></p>
